...
- `test-generation-harness.md`: Mechanism-isolating families, paired controls, oracle-backed analogues, validation scans, benchmarking traps, and stress-suite promotion.
...
1. Identify the algorithmic family and the suspected failure mechanism.
2. Load the closest topic file.
