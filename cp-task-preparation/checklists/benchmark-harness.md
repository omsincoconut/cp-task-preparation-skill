...
- Unless overridden, cap presumed-TL runs at $3 \times$ the official time limit and presumed-ML runs at $2 \times$ the official memory limit; record the cutoff as local benchmark policy.
